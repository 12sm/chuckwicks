<?php
/**
* Determines whether or not to display the sidenavbar based on an array of conditional tags or page templates.
*
* If any of the is_* conditional tags or is_page_template(template_file) checks return true, the sidenavbar will NOT be displayed.
*
...
*
* @return boolean True will display the sidenavbar, False will not
*
*/
class Roots_SideNavbar {
